...
export const ATTRIBUTES: AttributeDef[] = [
  {
    key: 'agility',
    label: 'Agilidade',
    description: 'Representa velocidade, reflexos e equilíbrio. Governa perícias como Furtividade, Tiro e Montaria.',
  },
  {
    key: 'smarts',
    label: 'Astúcia',
    description: 'Inteligência, sagacidade e raciocínio rápido. Governa perícias como Percepção, Pesquisa e Conhecimento.',
  },
  {
    key: 'spirit',
    label: 'Espírito',
    description: 'Força de vontade, determinação interior e carisma. Governa Intimidação, Provocar e Persuasão.',
  },
  {
    key: 'strength',
    label: 'Força',
    description: 'Potência física bruta e capacidade de carga. Afeta dano corpo-a-corpo.',
  },
  {
    key: 'vigor',
    label: 'Vigor',
...
export const SKILLS: SkillDef[] = [
  ...
  { key: 'Tiro', label: 'Tiro', linkedAttribute: 'agility', description: 'Armas de projétil e distância' },
  { key: 'Montaria', label: 'Montaria', linkedAttribute: 'agility', description: 'Cavalgar montarias' },
  ...
  { key: 'Luta', label: 'Luta', linkedAttribute: 'agility', description: 'Combate corpo a corpo' },
  { key: 'Pilotagem', label: 'Pilotagem', linkedAttribute: 'agility', description: 'Pilotar aeronaves' },
  { key: 'Condução', label: 'Condução', linkedAttribute: 'agility', description: 'Pilotar veículos terrestres' },
  { key: 'Navegação', label: 'Navegação', linkedAttribute: 'agility', description: 'Pilotar embarcações' },
  { key: 'Jogatina', label: 'Jogatina', linkedAttribute: 'smarts', description: 'Jogos de azar e apostas' },
  { key: 'Ciência', label: 'Ciência', linkedAttribute: 'smarts', description: 'Conhecimentos científicos avançados' },
  { key: 'Conhecimento Geral', label: 'Conhecimento Geral', linkedAttribute: 'smarts', description: 'Cultura geral e senso comum' },
  { key: 'Medicina', label: 'Medicina', linkedAttribute: 'smarts', description: 'Tratar ferimentos e doenças' },
  { key: 'Eletrônica', label: 'Eletrônica', linkedAttribute: 'smarts', description: 'Operar e reparar eletrônicos' },
  { key: 'Pesquisa', label: 'Pesquisa', linkedAttribute: 'smarts', description: 'Investigar e coletar informações' },
  { key: 'Percepção', label: 'Percepção', linkedAttribute: 'smarts', description: 'Detectar detalhes e ameaças' },
  { key: 'Ocultismo', label: 'Ocultismo', linkedAttribute: 'smarts', description: 'Conhecimento sobrenatural e místico' },
  { key: 'Reparos', label: 'Reparos', linkedAttribute: 'smarts', description: 'Consertar máquinas e dispositivos' },
  ...
  { key: 'Intimidação', label: 'Intimidação', linkedAttribute: 'spirit', description: 'Amedrontar e coagir oponentes' },
  { key: 'Persuasão', label: 'Persuasão', linkedAttribute: 'spirit', description: 'Convencer e negociar com outros' },
  { key: 'Provocar', label: 'Provocar', linkedAttribute: 'smarts', description: 'Distrair e irritar oponentes em combate' },
  { key: 'Fé', label: 'Fé', linkedAttribute: 'spirit', description: 'Canalizar poder divino' },
  { key: 'Magias', label: 'Magias', linkedAttribute: 'smarts', description: 'Lançar feitiços e rituais arcanos' },
  { key: 'Foco', label: 'Foco', linkedAttribute: 'spirit', description: 'Canalizar poder psíquico ou interior' },
  { key: 'Atuação', label: 'Atuação', linkedAttribute: 'spirit', description: 'Cantar, dançar, atuar e entreter' },
]
