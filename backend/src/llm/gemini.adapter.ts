...
export class GeminiAdapter implements Narrator {
  ...
  private buildNarratorSystemPrompt(opts: {
    ...
    const lines = [
      ...
      '  ],',
      '  "npcAttacks": [',
      '    { "npcId": "<id of the attacking NPC>", "skillDie": <6|8|10|12>, "damageFormula": "<str+d6 or 2d6 etc>", "ap": 0, "attackDescription": "<brief description of how the NPC attacks, e.g.: Golpeia com a espada, Dispara uma flecha>" }',
      '  ]',
      '},',
      '',
      ...
      '- NPC ATTACKS: hostile NPC attacks this turn → fill "npcAttacks": [{ "npcId", "skillDie": 6|8|10|12 (6=common, 8=trained, 10=champion, 12=elite), "damageFormula" (e.g. "str+d6", "2d6"), "ap": 0, "attackDescription": "<brief description of how the NPC attacks in Brazilian Portuguese, e.g.: \'Golpeia com a espada\', \'Dispara uma flecha\', \'Lança uma bola de fogo\'" }]. No attack → []. attackDescription is MANDATORY for every npcAttacks entry.',
