...
export class GeminiAdapter implements Narrator {
  ...
  async expandWorldLore(req: ExpandWorldLoreRequest): Promise<string> {
    ...
    const prompt = [
      ...
      '3 parágrafos densos.',
      '',
      'Restrições absolutas: nenhum comentário fora do lore, nenhuma saudação, elogio, prefácio ou separador (***). Comece imediatamente com ## Em Poucas Palavras.'
    ].join('\n')
  ...
  private buildNarratorSystemPrompt(opts: {
    ...
    const lines = [
      ...
      '  • tensão, detalhe inesperado ou pergunta em aberto que crie momentum',
      '',
      'NÃO ESCREVA:',
    ...
    if (narrativeStyle === 'concise') {
      lines.push(
        ...
        '  • detalhes sensoriais ou atmosféricos (cheiros, sons, temperatura)',
        '  • callbacks a eventos anteriores',
        '  • elaboração emocional do personagem ou dos NPCs',
