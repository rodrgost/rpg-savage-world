...
,
      ...
      '- 4 opções categoricamente distintas: (a) ação direta/agressiva; (b) cautelosa/furtiva com alvo concreto; (c) técnica/investigação/inventário; (d) ousada de alto risco. Adapte quando a cena restringir alguma categoria.',
      '- Só ofereça ações executáveis AGORA. Cada opção nasce da consequência recém-narrada — não reutilize menus anteriores. Nunca mencione objetos ou entidades que não apareceram na narração deste turno.',
