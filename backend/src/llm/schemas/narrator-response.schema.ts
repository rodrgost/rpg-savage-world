  ...
  properties: {
    ...
    segments: {
      ...
      items: {
        ...
        required: ['type', 'text'],
        propertyOrdering: ['type', 'npcId', 'npcName', 'disposition', 'text']
      }
    },
    options: {
      type: 'ARRAY',
        ...
        properties: {
          ...
          actionPayload: {
            ...
            properties: {
              ...
              damageFormula: { type: 'STRING', nullable: true },
              to: { type: 'STRING', nullable: true },
              input: { type: 'STRING', nullable: true },
              ap: { type: 'INTEGER', nullable: true }
            },
            propertyOrdering: ['skill', 'attribute', 'targetId', 'damageFormula', 'to', 'input', 'ap']
          },
          ...
          diceCheck: {
            ...
            propertyOrdering: ['required', 'skill', 'attribute', 'modifier', 'tn', 'reason']
          }
        },
    ...
    npcs: {
      ...
      items: {
        ...
        required: ['id', 'name', 'disposition', 'newlyIntroduced'],
        propertyOrdering: ['id', 'name', 'disposition', 'newlyIntroduced', 'status']
      }
    },
    itemChanges: {
      type: 'ARRAY',
